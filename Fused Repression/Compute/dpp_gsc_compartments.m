...
pMadK4g = 1./(1+(pMadg/K(2)).^4); %transcriptional actn and repressed translation of Fu-S
%cb
pMadK2c = (pMadcn/K(1)).^4/(1+(pMadcn/K(1)).^4); %transcriptional actn and translation of Dad 
pMadK4c = 1./(1+(pMadc/K(2)).^4); %transcriptional actn and repressed translation of Fu-S
...
dFSg = (pMadK4g - FSg)/tau(4) - km(t)*(FSg-FSc);
...
dFSc = (pMadK4c - FSc)/tau(4) + km(t)*(FSg-FSc);
